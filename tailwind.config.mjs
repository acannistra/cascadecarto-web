...
export default {
  ...
  theme: {
    colors: {
      ...
      'tea_green': { DEFAULT: '#deefb7', 100: '#35450f', 200: '#6a8b1e', 300: '#9fd02e', 400: '#bfe072', 500: '#deefb7', 600: '#e5f3c6', 700: '#ecf6d4', 800: '#f2f9e3', 900: '#f9fcf1' }, 'celadon': { DEFAULT: '#98dfaf', 100: '#123a1e', 200: '#23733d', 300: '#35ad5b', 400: '#60ce83', 500: '#98dfaf', 600: '#aee6c0', 700: '#c2eccf', 800: '#d6f3df', 900: '#ebf9ef' }, 'keppel': { DEFAULT: '#5fb49c', 100: '#122520', 200: '#234b40', 300: '#357060', 400: '#47967f', 500: '#5fb49c', 600: '#7fc3b0', 700: '#9fd2c4', 800: '#bfe1d7', 900: '#dff0eb' }, 'marian_blue': { DEFAULT: '#414288', 100: '#0d0d1b', 200: '#1a1a36', 300: '#272751', 400: '#34356b', 500: '#414288', 600: '#5758ae', 700: '#8182c2', 800: '#abacd7', 900: '#d5d5eb' }, 'palatinate': { DEFAULT: '#682d63', 100: '#150914', 200: '#291227', 300: '#3e1b3b', 400: '#53234f', 500: '#682d63', 600: '#9a4293', 700: '#be67b7', 800: '#d49acf', 900: '#e9cce7'},
